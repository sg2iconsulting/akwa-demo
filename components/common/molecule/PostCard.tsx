  ...
  return (
    <div className="w-full xl:w-[63%] xl:h-[695px] flex flex-col rounded-[20px] overflow-hidden">
      <div className="w-full rounded-t-[20px] overflow-hidden">
        <Image imageClassename={imageClassename} src={imgSrc} alt={title} />
      </div>
      ...
      >
        <Paragraph className={dateClassename}>{date}</Paragraph>
        <Heading tag="h3" className={titleClassename}>
          {title}
        </Heading>
        <Paragraph className={descriptionClassename}>{description}</Paragraph>
