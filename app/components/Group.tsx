        ...
        <div className="flex flex-col md:flex-row md:justify-between w-full h-full gap-5 md:gap-8 lg:gap-12">
          <div className="flex flex-col md:w-1/2 gap-3 lg:gap-6 xl:gap-10 2xl:gap-12 h-full my-auto">
            <div className="flex flex-col">
              <h1 className="text-[20px] md:text-[24px] xl:text-[40px] 2xl:text-[50px] font-black">Akwa Group</h1>
            ...
            <button className="w-28 h-7 md:w-36 md:h-10 xl:w-40 xl:h-12 2xl:w-48 2xl:h-16 text-white font-bold bg-[#19A0BF] rounded-full text-[10px] md:text-[12px] xl:text-[16px] 2xl:text-[20px]">
              voir plus
            </button>
          </div>
