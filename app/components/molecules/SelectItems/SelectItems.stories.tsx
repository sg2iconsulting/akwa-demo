...
// import LanguageSelect, { LanguageOptions } from './LanguageSelect';
...
//   argTypes: {
//     languageItems: {
//       description: 'Array of language options for the select dropdown',
//       control: {
//         type: 'object',
//       },
//       table: {
//         type: { summary: 'Array<LanguageOptions>' },
//       },
//     },
//     languageItemsTextColor: {
//       description: 'Text color for the language items in the dropdown',
//       control: 'color',
//       table: {
//         type: { summary: 'string' },
//       },
...
//       description: 'Background color of the items when hovered',
//       control: 'color',
//       table: {
//         type: { summary: 'string' },
//       },
//     },
//     iconColor: {
//       description: 'Color for the icon in the dropdown',
//       control: 'color',
//       table: {
//         type: { summary: 'string' },
//       },
//     },
//     chevronColor: {
//       description: 'Color for the chevron icon',
//       control: 'color',
//       table: {
//         type: { summary: 'string' },
//       },
//     },
//     iconPath: {
//       description: 'Path data for the icon displayed in the dropdown',
//       control: 'text',
//       table: {
//         type: { summary: 'string' },
//       },
//     },
//     iconSize: {
//       description: 'Size of the icon displayed in the dropdown',
//       control: 'number',
//       table: {
//         type: { summary: 'number' },
//       },
//     },
//   },
//   tags: ['component', 'molecule', 'dropdown', 'language selector'],
// };
...
const meta: Meta<typeof SelectItems> = {
  title: "molecules/SelectItems",
  component: SelectItems,
  argTypes: {
    languageItemsTextColor: { control: "color" },
    iconColor: { control: "color" },
    iconSize: { control: { type: "number", min: 10, max: 50, step: 2 } },
  },
};
