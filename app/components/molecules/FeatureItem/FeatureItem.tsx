...
const FeatureItem: React.FC<FeatureItemProps> = ({
  ...
  return (
    <div className="flex gap-1 lg:gap-2 2xl:gap-4 items-center">
      <FeatureIcon icon={icon} color={iconColor} className={iconClassename} style={iconStyle} />
      <Heading tag="h2" className={headingClassName} style={headingStyle} >{text}</Heading>
    </div>
  );
};
