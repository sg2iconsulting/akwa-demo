...
export const CustomStyles: StoryObj<InputSectionBannerProps> = {
  args: {
    ...
    buttonClassename: 'absolute inset-y-1 right-1 px-4 py-2 rounded-lg font-bold',
...
export const DarkMode: StoryObj<InputSectionBannerProps> = {
  args: {
    ...
    buttonClassename: 'absolute inset-y-1 right-1 px-4 py-2 bg-yellow-500 text-white rounded-lg font-bold',
