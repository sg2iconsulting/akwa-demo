...
const LanguageSelect = () => {
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="relative text-black dark:text-white inline-block items-center">
        {/* Trigger Button */}
        <div
        ...
        >
          ...
          <HiMiniChevronDown className="fill-black dark:fill-white" />
        </div>
        {isOpen && (
          <div className="absolute left-0 mt-2 w-full border border-black dark:border-white rounded-lg shadow-lg">
            {options.map((option) => (
              <div
                key={option.value}
