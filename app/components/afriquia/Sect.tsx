  ...
  return (
    <section className="font-poppins w-full max-w-[2000px] mx-auto ">
      <div className="w-full h-full px-5 md:px-10 lg:px-20">
        ...
        >
          <div
            className={`flex flex-col w-full sm:w-[75%] h-full gap-5 md:gap-12 lg:gap-16 xl:gap-20 2xl:gap-24 justify-center px-6 md:px-10 xl:px-14 2xl:px-20`}
          >
            <div className="flex flex-col gap-1 md:gap-2 lg:gap-3 xl:gap-4 2xl:gap-5">
              ...
              <p className="font-medium text-[8px] sm:text-[11px] 2xl:text-[24px] w-full z-40">
                {descrip}
              </p>
            </div>
            <motion.button
          ...
          <div className="w-full hidden h-[50%] sm:h-full sm:flex items-end">
            <img
              src={imgSrc}
              alt="Your Image"
