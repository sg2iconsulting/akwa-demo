  ...
  return (
    <section className="font-poppins w-full max-w-[2000px] mx-auto">
      <div className="w-full h-full p-5 md:px-10 lg:px-20">
        <div
          className="w-full h-full relative bg-cover bg-center rounded-3xl 2xl:rounded-[50px] p-3 text-white flex flex-col justify-center gap-2 aspect-[3/1] 2xl:h-[675px] "
          style={{ backgroundImage: `url(${imgSrc})` }}
        >
          <div className="absolute inset-0 bg-black bg-opacity-30 z-40 rounded-3xl 2xl:rounded-[50px]"></div>
          <h2 className="text-[20px] md:text-[24px] xl:text-[40px] 2xl:text-[60px] font-black md:ml-4 lg:ml-8 xl:ml-16 z-50">
            {title}
          </h2>
