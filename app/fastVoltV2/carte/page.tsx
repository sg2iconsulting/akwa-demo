  ...
  return (
    <main className="flex flex-col w-full gap-y-10 lg:gap-y-24">
      <section className="w-full">
        ...
        <HeroSlider
          slides={[
            {
              type: "image",
              src: "/fastVolt/carte/fastVoltCartebg.png",
              title: "Carte des bornes",
              subtitle: "Chargeurs rapides et semi-rapides",
            },
          ]}
          paginationStyles={`
            .swiper-pagination {
      ...
      <section>
        <MapComponent
          title=""
          center={[33.5731104, -7.589843]}
          zoom={15}
          markers={[
            {
              position: [33.5731104, -7.589843],
              title: "Akwa Group Headquarters",
              info: "<p>123 Example Street<br/>Casablanca, Morocco</p>",
            },
          ]}
        />
        <Footer
