      ...
      <section className="w-full">
        <Navbar
          ...
          desktopNavbarProps={{
            ...
            selectItemClassename: "flex items-center gap-2 rounded-lg bg-transparent h-7 px-2 cursor-pointer focus:outline-none",
        ...
        />
        <FastVoltHeader
          backgroundImageSrc="/fastVolt/navBackFv.png"
